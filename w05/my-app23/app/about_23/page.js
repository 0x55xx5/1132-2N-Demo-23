...
export default function Page() {
    return (
      <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
        <div className="col-span-3">
          ...
          <div className="space-y-8">
            <p>
              ...
              paradise away from home. But it&apos; not just about the luxury cabins.
              It&apos; about the experience of reconnecting with nature and enjoying
            ...
            <p>
              ...
              splendor. It&apos; a place to slow down, relax, and feel the joy of
        ...
        <div className="col-span-2">
          <Image src={ab2} alt="Family that manages The Wild Oasis" />
        </div>
